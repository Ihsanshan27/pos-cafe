...
exports.InventoryLogsController = void 0;
...
let InventoryLogsController = class InventoryLogsController {
    inventoryLogsService;
    constructor(inventoryLogsService) {
...
], InventoryLogsController.prototype, "create", null);
__decorate([
    (0, roles_decorator_1.Roles)(client_1.Role.OWNER, client_1.Role.MANAGER),
    (0, common_1.Get)(),
...
exports.InventoryLogsController = InventoryLogsController = __decorate([
    ...
    (0, common_1.Controller)('inventory-logs'),
    __metadata("design:paramtypes", [inventory_logs_service_1.InventoryLogsService])
], InventoryLogsController);
//# sourceMappingURL=inventory-logs.controller.js.map